															...
															<aside id="sidebar-nav"
																...
																<ul
																	...
																	<li class=""><a href="telecom-consulting.jsp">Telecom
																			Consulting</a></li>
																	<li class="active"><a href="mobility-services.jsp"
																		style="color: white;">Mobility Services</a></li>
													...
													<div class="elementor-widget-container">
														<div class="elementor-text-editor elementor-clearfix">
															<h1 style="color: #296484">
																<strong>Mobility Services</strong>
															</h1>
															<p style="color: #737777;">Enterprise mobility and
																M2M solutions adoptions are increasing day by day.
																Mobility and BYOD is increasing enterprise challenges of
																porting applications on mobile devices. 61% of
																enteprises plan to enhance their mobility capability
																during the next 3 years and 48% believe they will become
																leaders in their industries by adopting innovative
																mobility solutions. Our Mobility Offerings shall enable
																an enterprise to launch an innovative application in
																less than 6 weeks. Our compressive mobility libraries
																shall enable an enterprise to fast forward
																implementation and seamlessly integrate with the back
																end line of business application. We can build and
																deliver applications on any one of the following device
																types.</p>

															<p>
																<img src="images/Mobility_Services.png"
																	alt="Mobility Services" />
															</p>

															<h4 style="color: #296484">We have extensive
																experience in building both Native and Hybrid
																applications to support following scenarios in mobility</h4>
															<ul style="color: #737777;">
																<li>Audio / Video applications</li>
																<li>Chat applications</li>
																<li>WiFi Connect applications</li>
																<li>Location aware applications</li>
																<li>Data backup applications</li>
																<li>B2B Enterprise Applications<br /></li>
															</ul>
